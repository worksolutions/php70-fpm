...
RUN apt-get update \
	...
	&& pecl install memcached memcache xdebug imagick \
	&& docker-php-ext-enable memcached memcache xdebug imagick mbstring mysqli pdo_mysql intl soap gd mcrypt opcache zip  \
